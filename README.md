...
<p align="center">
  ...
  <h1 align="center">IUT-SAE1.02RDBL | CookiesLand</h1>
</p>
...
<p align="center">
    ...
    <br/>
    <br/>
    <a href="https://github.com/yannouuuu/IUT-SAE1.02RDBL/"><strong>Voir le projet complet sur GitHub »</strong></a>
</p>
...
**CookiesLand** est un jeu textuel au tour par tour où vous développez un empire de cookies en répondant à des questions d’économie-gestion. Chaque bonne réponse déclenche un bonus de production, tandis qu’une mauvaise applique un malus. L’objectif est de franchir des paliers successifs pour devenir le plus riche possible tout en maximisant un score pédagogique. Le projet, réalisé dans le cadre de la SAE 1.02 du BUT Informatique, illustre la comparaison d’approches algorithmiques appliquées à une expérience ludo-éducative.
...
```bash
# Cloner le dépôt
git clone https://github.com/yannouuuu/IUT-SAE1.02RDBL/
...
3. *Tour de jeu* : Prenez des décisions via les options proposées.

## Exemple de gameplay
![CookiesLand Showcase](./shots/)
...
- Anaëlle MOREY
  > anaelle.morey2.etu@univ-lille.fr
